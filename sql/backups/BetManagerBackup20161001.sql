...
--
-- Name: logbook_overview; Type: VIEW; Schema: public; Owner: ayoung
--

CREATE VIEW logbook_overview AS
 SELECT bet.stake,
    bet.odds,
    bet.bookieaccountid,
    bet.commission,
    ...
    bet.bet_specific,
    bet.betmarketid,
    bet_type.name AS tmp_bet_type_name,
    bookie.name AS tmp_bookie_name,
    sport.sporttype AS tmp_sport_name,
    bet_status.name AS tmp_bet_status_name,
   ...
   FROM bet,
    ...
    bet_status,
    bet_type
  WHERE ((bet.bookieaccountid = bookie_account.id) AND (bookie_account.bookieid = bookie.id) AND (bet.betstatusid = bet_status.id) AND (bet.betmarketid = bet_market.id) AND (bet_market.sportid = sport.id) AND (bet.bettypeid = bet_type.id));


ALTER TABLE logbook_overview OWNER TO ayoung;
...
--
-- Name: fki_bet_bet_market_id_fk; Type: INDEX; Schema: public; Owner: ayoung
--

CREATE INDEX fki_bet_bet_market_id_fk ON bet USING btree (betmarketid);
...
--
-- Name: bet_bet_market_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: ayoung
--

ALTER TABLE ONLY bet
    ADD CONSTRAINT bet_bet_market_id_fk FOREIGN KEY (betmarketid) REFERENCES bet_market(id);
